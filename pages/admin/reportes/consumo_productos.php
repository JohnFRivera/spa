...
$users = require_once '../../../Back/Controllers/reportes/controlador_reportes_productos.php';
;
?>
<!DOCTYPE html>
<html lang="es">
                    ...
                    <div class="col">
                        <div class="bg-light rounded-4 shadow-sm p-3">
                            <ul class="nav bg-body-secondary rounded-3 gap-0 p-2 mb-2">
                                ...
                                <li class="nav-item">
                                    <a href="./clientes_frecuentes.php" class="btn btn-outline-success border-0 rounded-3 fs-5 btn-aside">
                                        Clientes Frecuentes
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="./consumo_productos.php" class="btn btn-outline-success border-0 rounded-3 fs-5 btn-aside active">
                                        Consumo Productos
                                    </a>
                                </li>
                            </ul>
