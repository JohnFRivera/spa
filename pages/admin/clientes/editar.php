                    ...
                    <div class="bg-light rounded-4 shadow-sm p-3">
                        ...
                        <div class="row mt-3">
                            <form action="" method="post" class="col-12 col-md-9 col-lg-5">
                                ...
                                <label for="direccion" class="fw-semibold ms-1">Teléfono</label>
                                <div class="input-group rounded-3 mb-2">
                                    <input type="tel" name="direccion" id="direccion" class="form-control" value=<?php echo $direccion ?> required>
